...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <div class="col-md-6">
            ...
            <asp:TextBox ID="txtHotel" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
        </div>

        <div class="col-md-6">
            <asp:Label ID="lblNumeroHabitacion" runat="server" Text="Numero de habitación"></asp:Label>
            <asp:TextBox ID="txtNumeroHabitacion" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
        </div>
